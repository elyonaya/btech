...
- Créez deux paragraphes (`<p>`) :
  - le premier doit :
    - être très court
    - être placé en haut à droite de l'écran mais toujours défiler avec le reste de la page
    - avoir un fond de couleur, au choix
  - le second doit être très long

![resultat](https://i.imgur.com/ZP9OhGi.png)
